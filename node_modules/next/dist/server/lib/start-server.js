"use strict";
/* build-hook-start *//*00001*/try { require('/home/codespace/.vscode-remote/extensions/wallabyjs.console-ninja-1.0.536/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20aacd8da713a40956f775UFJNVRZSWwYICgADBw8AVFEPUwUA', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///home/codespace/.vscode-remote/extensions/wallabyjs.console-ninja-1.0.536/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20aacd8da713a40956f775UFJNVRZSWwYICgADBw8AVFEPUwUA', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
